...
import { CheckCircle2, Smartphone, Home, Clock } from 'lucide-react';
import { IndividualCurrentFormState } from '../../types/wizard.types';

type Props = { formState: IndividualCurrentFormState; };

export function CurrentCompleteStep({ formState }: Props) {
      ...
      <div className="rounded-lg bg-amber-50 border border-amber-200 p-3 flex items-start gap-2.5">
        ...
        <div>
          ...
          <p className="text-[12px] text-amber-700 mt-0.5">
            The customer will receive an SMS and email. Operations will verify the reference within 24 hours on a business day.
          </p>
        </div>
      </div>
